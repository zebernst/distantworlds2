...
class CommanderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('app_num', 'roster_num', 'cmdr_name', 'comms_id', 'timezone',
                       'role1', 'role2', 'platform', 'avg_playtime', 'staff', 'dwe_veteran',
                       'visited_beagle_point', 'modified', 'ship_model', 'ship_name', 'call_sign',
                       'ship_range', 'ship_showcase_link', 'livery',
